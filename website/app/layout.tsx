...
export const metadata: Metadata = {
  ...
  title: "Unit Toko | Portal Divisi BNI",
  description: "Ruang kerja terpadu pemesanan divisi, pengiriman, penagihan, dan pelaporan. Demo capstone dengan data simulasi.",
